...
if (isset($_GET['confirm'])) {
  updateSuccessJob($_GET['confirm'],$_GET['projects_id']);
}
?>
<script>
                      ...
                      <tr>
                        ...
                        <td style="width:30%;text-align:center;">
                          <?php if($dataPe["peiod_status"] == 1){ ?>
                            <a href="?confirm=<?php echo $dataPe['id'];?>&projects_id=<?php echo $_GET['id'];?>" class="btn btn-outline-info" onClick="javascript: return confirm('ยืนยันสถานะ');">แล้วเสร็จ</a>
                          <?php }?>
