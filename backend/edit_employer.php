                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="username" value="<?php echo $currentEmployer["username"];?>" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="telephone" id="telephone" value="<?php echo $currentEmployer["telephone"];?>" required>
                    </div>
                  </div>
                </div>
                <!-- <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Facebook<span style="color: red;"> *</span></label>
                      <input type="text" class="form-control" name="facebook_name" value="<?php echo $currentEmployer["facebook_name"];?>" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Line ID<span style="color: red;"> *</span></label>
                      <input type="text" class="form-control" name="line_id" value="<?php echo $currentEmployer["line_id"];?>" required>
                    </div>
                  </div>
                </div> -->
                <div align="center">
