                      ...
                      <tr>
                        ...
                        <td style="width:10%;text-align:center;">
                          <?php if($dataSc["work_end_date"] == "0000-00-00"){ ?>
                            <a href="?check_out=<?php echo $dataSc['id'];?>&users_id=<?php echo $currentUser['uid'];?>" class="btn btn-danger" onClick="javascript: return confirm('ยืนยันการลงเวลาออก');">ลงเวลาออก</a>
                          <?php }else{ ?>
                            <a href="edit_schedule_job.php?id=<?php echo $dataSc["id"];?>&users_id=<?php echo $currentUser['uid'];?>" class="btn btn-info">แก้ไข</a>
                            <a href="?delete=<?php echo $dataSc['id'];?>&users_id=<?php echo $currentUser['uid'];?>" class="btn btn-danger" onClick="javascript: return confirm('ยืนยันการลบ');">ลบ</a>
                          <?php } ?>
                        </td>
                      </tr>
